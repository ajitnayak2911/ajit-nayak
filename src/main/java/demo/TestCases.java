...
public class TestCases {
    ...
    public void testCase01() throws InterruptedException {
        ...
        // driver.findElements(By.xpath("//div[@class='eBFwI']"));
        ...
        // Locate the dropdown element for "How should you be addressed?" and select the
        // desired value
        ...
        // WebElement amPmDropdown = driver.findElement(By.xpath("(//div[@class='e2CuFe
        // eU809d'])[2]"));
        // amPmDropdown.click();

        // Locate and select the AM/PM option
        // WebElement amPmOption = driver.findElement(By.xpath("//div[@class='OA0qNb
        // ncFHed QXL7Te']//span[text()='" + amPm + "']"));
        ...
        WebElement Capturemessage = driver.findElement(By.xpath("//div[@class='vHW8K']"));
        String messageText = Capturemessage.getText();
        if (messageText.contains("Thanks for your response, Automation Wizard!")) {
